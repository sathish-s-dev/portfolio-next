	...
	return (
		<section
			...
			<div className='relative z-24 md:p-16 flex justify-center items-center'>
				...
				<div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 md:flex-row bg-light-400/5 border border-light-400/50 rounded-xl flex-1 max-w-[90%] gap-6 w-full p-6 py-12 lg:p-16 h-[500px] sm:p-10 backdrop-blur-xl md:gap-8 text-light-400 z-24 group transition-all duration-300'>
				...
				<div className='dark:block hidden absolute w-24 h-24 -z-20 rounded-full bg-red-800 bottom-6 right-12' />
				{/*  */}

...
import { MoonIcon, SunIcon, GearIcon as Settings } from '@radix-ui/react-icons';
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				<button className='focus-visible:ring-0 ring-0 focus-within:ring-0 mx-0 p-2 group outline-slate-200'>
